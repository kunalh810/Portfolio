...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description">Myself Kunal, an IT Graduate with a strong foundation in Software Development. Passionate about learning and implementing cutting-edge technologies to create innovative solutions.</p>
